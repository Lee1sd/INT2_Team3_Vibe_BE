 ...
 *
 * @param technicalAccuracy 기술적 정확성 원시 점수(의도 범위 0~8)
 * @param coreCoverage 핵심 내용 충족도 원시 점수(의도 범위 0~4)
 * @param reasoning 근거·판단 과정 원시 점수(의도 범위 0~3)
 * @param specificity 구체성·실무 연계 원시 점수(의도 범위 0~3)
 * @param tradeOffsAndExceptions 트레이드오프·예외 원시 점수(의도 범위 0~2)
 */
