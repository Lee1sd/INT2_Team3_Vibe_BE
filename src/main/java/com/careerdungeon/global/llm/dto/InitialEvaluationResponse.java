 ...
 *   <li>{@code weakestQuestionId} — 가장 낮은 점수를 받은 문항의 turn 번호. IS-002b 최종
 *       채점 호출 시에는 이 문항을 포함한 최초 3문항 전체와 꼬리질문을 합쳐 turn 1~4
 *       전체를 다시 전달한다(ADR-010). 최종 응답({@link FinalEvaluationResponse})에는
 *       이 필드가 존재하지 않는다</li>
