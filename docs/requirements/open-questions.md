...
| 4 | LLM 세부 모델 | 벤더는 Claude로 확정, Haiku 4.5 vs Sonnet 4.6은 미정 | 김한비가 2주차 실연동 전 프롬프트 테스트 후 확정. 확정 전 모델명 하드코딩 금지, 인터페이스 뒤로 추상화 | `docs/adr/ADR-003-llm-vendor-selection.md`, `docs/operations/llm-cost-policy.md` §3 | ⚠️ 미확정 (2주차 확정 예정, 담당: 김한비) |
