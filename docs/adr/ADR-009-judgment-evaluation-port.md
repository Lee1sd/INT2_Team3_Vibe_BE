...
- 작성일: 2026-07-13
- 관련 이슈/PR: #5
- 후속 결정: 2026-07-15, ADR-014에 따라 최종 평가 포트는 questionId 4 한 건을 받고
  judgment가 최초 1~3 서버 확정 점수와 합산한다.

> 아래 본문은 2026-07-13 당시 결정 기록이다. 최종 문항 범위와 루브릭 개수에 관한
> 현재 계약은 ADR-014를 우선하며, 포트 분리·Mock 경계 결정만 이 ADR에서 유지된다.
