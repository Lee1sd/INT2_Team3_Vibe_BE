...
| `domain/interview/**`, `domain/message/**`, `domain/persona/**`(엔티티/설정만), `resources/prompts/**` | ② 면접 엔진 + LLM 통합 | 김한비 | [`owners/kim-hanbi.md`](owners/kim-hanbi.md) |
| `domain/judgment/**`, `domain/progress/**` | ③ 평가·게이지·해금 | 최용성 | [`owners/choi-yongseong.md`](owners/choi-yongseong.md) |
